...
<main>
  <section class="cc-container cc-hero">
    <div>
      <span class="cc-kicker">7 оригинальных игр • единый аккаунт</span>
      <h1>Один баланс. <em>Семь разных механик.</em></h1>
      <p>Каскады, линии, пути, липкие вайлды, hold-and-respin, расширяющиеся символы, бомбы и неоновый tumble. Каждая игра рассчитывается сервером и сохраняет результат в истории аккаунта.</p>
  ...
  <section class="cc-section" id="games"><div class="cc-container"><div class="cc-section-head"><div><h2>Библиотека игр</h2><p>Все игры используют общий виртуальный рублёвый баланс.</p></div></div><div class="cc-games cc-games-library">
