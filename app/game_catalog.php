...
function game_catalog(): array {
    return [
        ...
        'neon-rush' => [
            'title'=>'Неоновый разгон','subtitle'=>'5/5 барабанов • плотность 9+ • tumble • напряжение','route'=>'play.php?game=neon-rush','theme'=>'neon','icon'=>'⚡','accent'=>'linear-gradient(135deg,#11164d,#7728d7 45%,#12d9e6)','cols'=>5,'rows'=>5,'volatility'=>'Очень высокая',
            ...
            'rules'=>'Для выигрыша символ должен пройти через все 5 барабанов, а суммарно в полном пути должно быть не менее 9 подходящих символов. После редкого попадания запускается tumble и повышается напряжение. Во фриспинах напряжение сохраняется между вращениями.'
        ],
        'sky-pantheon' => [
