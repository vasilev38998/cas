...
function site_nav(?array $user): void {
    ...
    if($user)echo '<a href="club.php">Клуб</a><a href="history.php">История</a><a href="account.php">Профиль</a>';if($user&&is_admin($user))echo '<a href="admin.php">Админ</a>';
